    ...
    const handleSubmit = async () => {
      try {
        ...
        if (password !== confirmPassword) {
          setError("Please fill in your credentials" || "incorrect password");
        } else {
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={{ backgroundColor: "#1D1D1B",flex:1,width:"100%" }}>
          <View>
            <Text style={{fontSize:26,color:"#FFFFFF",fontWeight:"bold",marginTop:15,padding:12}}>Create new password</Text>
            <Text style={{fontSize:16,color:"#FFFFFF",paddingLeft:12}}>
            Enter you new password. if you have forget it, then you have to do forget password.            </Text>
          </View>
